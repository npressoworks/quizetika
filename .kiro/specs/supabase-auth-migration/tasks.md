...
- [ ] 2. Auth Context & Profile Sync
- [ ] 2.1 認証コンテキストの移行と Cookie 同期
...
- [ ] 3. Middleware Integration (P)
- [ ] 3.1 ミドルウェアセッション更新とルートガードの統合 (P)
