...
### RPC 変更（`handle_record_ai_turn` — migration `20260725000000_shared_ai_turn_limit.sql`）
...
| `supabase/migrations/20260725000000_shared_ai_turn_limit.sql` | **新規**。RPC の NULL 許容拡張 |
