...
- [ ] 1.1 グローバルCSS変数と共通スタイル（Vanilla CSS/CSS Modules）の実装 (P)
...
- [ ] 3.4 退会処理中（delete_pending）のアクセスブロック実装
...
- [ ] 5.1 フォロー/フォロワー一覧画面 (/profile/[uid]/connections) の実装
...
- [ ] 5.3 リアクション履歴画面 (/profile/[uid]/likes) の実装
