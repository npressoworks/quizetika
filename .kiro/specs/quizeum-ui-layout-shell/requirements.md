...
4. When ログインユーザーがフッターのアカウントボタンを操作したとき, the Sidebar Component shall プロフィール・設定・ログアウトを含むポップアップメニューを表示する。
...
2. When ログインユーザーが Header のプロフィールボタンを操作したとき, the Header Component shall リスト・カスタムクイズ・プロフィール・設定・ログアウトを含むポップアップを表示する。
