...
- [x] 2. DB: 凍結ゲートと管理者専用RPCのマイグレーション
...
- [x] 3.2 (P) 既存マージサービスへの凍結例外マッピング追加
...
- [x] 4. ガードと導線
- [x] 4.1 (P) middlewareの凍結時admin限定ガード
...
- [x] 4.2 (P) クイズエディタのジャンル申請導線の凍結時非表示
...
- [x] 5. 管理者向けコミュニティ画面
- [x] 5.1 (P) マージ画面の凍結時ガード・バナー・保留提案の承認/却下
